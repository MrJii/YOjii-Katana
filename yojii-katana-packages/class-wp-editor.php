<?php
/**
 * Facilitates adding of the YOjii-Katana editor as used on the Write and Edit screens.
 *
 * @package YOjii-Katana
 * @since 3.3.0
 *
 * Private, not included by default. See wp_editor() in yojii-katana-site/general-template.php.
 */
	...
	public static function editor_settings($editor_id, $set) {
		...
		if ( self::$this_tinymce ) {
			...
			if ( empty( self::$first_init ) ) {
				...
				// YOjii-Katana default stylesheet and dashicons
				$mce_css = array(
					$dashicons,
					self::$baseurl . '/skins/YOjii-Katana/wp-content.css?' . $version
				);
