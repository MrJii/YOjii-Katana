...
function ms_upload_constants() {
	...
	if ( !defined( 'UPLOADBLOGSDIR' ) )
		define( 'UPLOADBLOGSDIR', 'yojii-katana-site/blogs.dir' );

	// Note, the main site in a post-MU network uses yojii-katana-site/uploads.
	// This is handled in wp_upload_dir() by ignoring UPLOADS for this case.
	if ( ! defined( 'UPLOADS' ) ) {
		define( 'UPLOADS', UPLOADBLOGSDIR . "/{$wpdb->blogid}/files/" );

		// Uploads dir relative to ABSPATH
		if ( 'yojii-katana-siteblogs.dir' == UPLOADBLOGSDIR && ! defined( 'BLOGUPLOADDIR' ) )
 ...
 * wp-includes/ms-files.php (yojii-katana-siteblogs.php in MU).
 *
 * @since 3.0.0
 */
