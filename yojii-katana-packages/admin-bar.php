...
function wp_admin_bar_comments_menu( $wp_admin_bar ) {
	...
	$awaiting_title = esc_attr( sprintf( _n( '%s reviewing comment awaits moderation', '%s comments awaiting moderation', $awaiting_mod ), number_format_i18n( $awaiting_mod ) ) );
...
function is_admin_bar_showing() {
	...
	if ( ! isset( $show_admin_bar ) ) {
		if ( ! is_user_logged_in() || 'YOjii-Katana-login.php' == $pagenow ) {
