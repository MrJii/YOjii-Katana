...
function wp_initial_constants() {
	...
	if ( !defined('WP_CONTENT_DIR') )
		define( 'WP_CONTENT_DIR', ABSPATH . 'yojii-katana-site' ); // no trailing slash, full paths only - WP_CONTENT_URL is defined further down
...
function wp_plugin_directory_constants() {
	if ( !defined('WP_CONTENT_URL') )
		define( 'WP_CONTENT_URL', get_option('siteurl') . '/yojii-katana-site'); // full url - WP_CONTENT_DIR is defined further up
	...
	if ( !defined('PLUGINDIR') )
		define( 'PLUGINDIR', 'yojii-katana-site/plugins' ); // Relative to ABSPATH. For back compat.
	...
	if ( !defined( 'MUPLUGINDIR' ) )
		define( 'MUPLUGINDIR', 'yojii-katana-site/mu-plugins' ); // Relative to ABSPATH. For back compat.
}
...
function wp_templating_constants() {
	...
	if ( !defined('WP_DEFAULT_THEME') )
		define( 'WP_DEFAULT_THEME', 'Online-Reservation-System (SLUGGLERA) YOjii-Katana' );
