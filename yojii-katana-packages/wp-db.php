...
<h1>SORRY! We cannot find database connection... :(</h1>
<p>This either means that the username and password information in your <code>yojii-katana-config.php</code> file is incorrect or we can't contact the database server at <code>%s</code>. This could mean your host's database server is down.</p>
<ul>
	<li>Check username and password.</li>
	<li>Check correct hostname.</li>
	<li>Are you sure that the mysql database server is running?</li>
</ul>
<p>If you're unsure what these terms mean you should probably contact your host.
 If you still need help you can always visit the <a href='https://facebook.com/YOjii-Katana/'>YOjii-Katana Facebook Support</a>.</p>
" ), htmlspecialchars( $this->dbhost, ENT_QUOTES ) ), 'db_connect_fail' );
	...
	public function check_connection( $allow_bail = true ) {
		...
		$this->bail( sprintf( ( "
<h1>SORRY! We cannot redefine database connection... :(</h1>
...
<p>If you're unsure what these terms mean you should probably contact your host. If you still need help you can always visit the <a href='https://facebook.com/YOjii-Katana'>YOjii-Katana Facebook Support</a>.</p>
" ), htmlspecialchars( $this->dbhost, ENT_QUOTES ) ), 'db_connect_fail' );
	...
	public function check_database_version() {
		...
		if ( version_compare($this->db_version(), $required_mysql_version, '<') )
			return new WP_Error('database_version', sprintf( __( '<strong>ERROR</strong>: YOjii-Katana %1$s requires MySQL %2$s or higher' ), $wp_version, $required_mysql_version ));
	}
