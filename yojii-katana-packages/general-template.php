...
function wp_logout_url($redirect = '') {
	...
	$logout_url = add_query_arg($args, site_url('YOjii-Katana-login.php', 'login'));
...
function wp_login_url($redirect = '', $force_reauth = false) {
	$login_url = site_url('YOjii-Katana-login.php', 'login');
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'YOjii-Katana-login.php?action=register', 'login' ) );
}
...
function wp_login_form( $args = array() ) {
	...
	$form = '
		<form name="' . $args['form_id'] . '" id="' . $args['form_id'] . '" action="' . esc_url( site_url( 'YOjii-Katana-login.php', 'login_post' ) ) . '" method="post">
			' . $login_form_top . '
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	$lostpassword_url = add_query_arg( $args, network_site_url('YOjii-Katana-login.php', 'login') );
...
function get_the_generator( $type = '' ) {
	...
	switch ( $type ) {
		case 'html':
			$gen = '<meta name="generator" content="YOjii-Katana ' . get_bloginfo( 'version' ) . '">';
			break;
		case 'xhtml':
			$gen = '<meta name="generator" content="YOjii-Katana ' . get_bloginfo( 'version' ) . '" />';
			break;
		case 'atom':
			$gen = '<generator uri="http://github.com/MrJii/YOjii-Katana" version="' . get_bloginfo_rss( 'version' ) . '">YOjii-Katana</generator>';
			break;
		case 'rss2':
			$gen = '<generator>http://github.com/MrJii/YOjii-Katana/?v=' . get_bloginfo_rss( 'version' ) . '</generator>';
			break;
		case 'rdf':
			$gen = '<admin:generatorAgent rdf:resource="http://github.com/MrJii/YOjii-Katana/?v=' . get_bloginfo_rss( 'version' ) . '" />';
			break;
		case 'comment':
			$gen = '<!-- generator="YOjii-Katana/' . get_bloginfo( 'version' ) . '" -->';
			break;
		case 'export':
			$gen = '<!-- generator="YOjii-Katana/' . get_bloginfo_rss('version') . '" created="'. date('Y-m-d H:i') . '" -->';
			break;
	}
