<?php
/**
 * YOjii-Katana core upgrade functionality.
 *
...
'wp.php',
// 2.0.8
'yojii-katana-packages/js/tinymce/plugins/inlinepopups/readme.txt',
// 2.1
...
'yojii-katana-packages/comment-functions.php',
'yojii-katana-packages/feed-functions.php',
'yojii-katana-packages/functions-compat.php',
'yojii-katana-packages/functions-formatting.php',
'yojii-katana-packages/functions-post.php',
'yojii-katana-packages/js/dbx-key.js',
'yojii-katana-packages/js/tinymce/plugins/autosave/langs/cs.js',
'yojii-katana-packages/js/tinymce/plugins/autosave/langs/sv.js',
'yojii-katana-packages/links.php',
'yojii-katana-packages/pluggable-functions.php',
'yojii-katana-packages/template-functions-author.php',
'yojii-katana-packages/template-functions-category.php',
'yojii-katana-packages/template-functions-general.php',
'yojii-katana-packages/template-functions-links.php',
'yojii-katana-packages/template-functions-post.php',
'yojii-katana-packages/wp-l10n.php',
// 2.2
'wp-admin/cat-js.php',
'wp-admin/import/b2.php',
'yojii-katana-packages/js/autosave-js.php',
'yojii-katana-packages/js/list-manipulation-js.php',
'yojii-katana-packages/js/wp-ajax-js.php',
// 2.3
...
'wp-admin/xfn.js',
'yojii-katana-packages/js/tinymce/license.html',
// 2.5
...
'yojii-katana-packages/images/wlw/WpComments.png',
'yojii-katana-packages/images/wlw/WpIcon.png',
'yojii-katana-packages/images/wlw/WpWatermark.png',
'yojii-katana-packages/js/dbx.js',
'yojii-katana-packages/js/fat.js',
'yojii-katana-packages/js/list-manipulation.js',
'yojii-katana-packages/js/tinymce/langs/en.js',
'yojii-katana-packages/js/tinymce/plugins/autosave/editor_plugin_src.js',
'yojii-katana-packages/js/tinymce/plugins/autosave/langs',
'yojii-katana-packages/js/tinymce/plugins/directionality/images',
'yojii-katana-packages/js/tinymce/plugins/directionality/langs',
'yojii-katana-packages/js/tinymce/plugins/inlinepopups/css',
'yojii-katana-packages/js/tinymce/plugins/inlinepopups/images',
'yojii-katana-packages/js/tinymce/plugins/inlinepopups/jscripts',
'yojii-katana-packages/js/tinymce/plugins/paste/images',
'yojii-katana-packages/js/tinymce/plugins/paste/jscripts',
'yojii-katana-packages/js/tinymce/plugins/paste/langs',
'yojii-katana-packages/js/tinymce/plugins/spellchecker/classes/HttpClient.class.php',
'yojii-katana-packages/js/tinymce/plugins/spellchecker/classes/TinyGoogleSpell.class.php',
'yojii-katana-packages/js/tinymce/plugins/spellchecker/classes/TinyPspell.class.php',
'yojii-katana-packages/js/tinymce/plugins/spellchecker/classes/TinyPspellShell.class.php',
'yojii-katana-packages/js/tinymce/plugins/spellchecker/css/spellchecker.css',
'yojii-katana-packages/js/tinymce/plugins/spellchecker/images',
'yojii-katana-packages/js/tinymce/plugins/spellchecker/langs',
'yojii-katana-packages/js/tinymce/plugins/spellchecker/tinyspell.php',
'yojii-katana-packages/js/tinymce/plugins/YOjii-Katana/images',
'yojii-katana-packages/js/tinymce/plugins/YOjii-Katana/langs',
'yojii-katana-packages/js/tinymce/plugins/YOjii-Katana/YOjii-Katana.css',
'yojii-katana-packages/js/tinymce/plugins/wphelp',
'yojii-katana-packages/js/tinymce/themes/advanced/css',
'yojii-katana-packages/js/tinymce/themes/advanced/images',
'yojii-katana-packages/js/tinymce/themes/advanced/jscripts',
'yojii-katana-packages/js/tinymce/themes/advanced/langs',
// 2.5.1
'yojii-katana-packages/js/tinymce/tiny_mce_gzip.php',
// 2.6
'wp-admin/bookmarklet.php',
'yojii-katana-packages/js/jquery/jquery.dimensions.min.js',
'yojii-katana-packages/js/tinymce/plugins/YOjii-Katana/popups.css',
'yojii-katana-packages/js/wp-ajax.js',
// 2.7
...
'yojii-katana-packages/images/audio.png',
'yojii-katana-packages/images/css.png',
'yojii-katana-packages/images/default.png',
'yojii-katana-packages/images/doc.png',
'yojii-katana-packages/images/exe.png',
'yojii-katana-packages/images/html.png',
'yojii-katana-packages/images/js.png',
'yojii-katana-packages/images/pdf.png',
'yojii-katana-packages/images/swf.png',
'yojii-katana-packages/images/tar.png',
'yojii-katana-packages/images/text.png',
'yojii-katana-packages/images/video.png',
'yojii-katana-packages/images/zip.png',
'yojii-katana-packages/js/tinymce/tiny_mce_config.php',
'yojii-katana-packages/js/tinymce/tiny_mce_ext.js',
// 2.8
'wp-admin/js/users.js',
'yojii-katana-packages/js/swfupload/plugins/swfupload.documentready.js',
...
'wp-includes/js/tinymce/plugins/YOjii-Katana/js',
...
'wp-includes/js/tinymce/plugins/YOjii-Katana/img/help.gif',
'wp-includes/js/tinymce/plugins/YOjii-Katana/img/more.gif',
'wp-includes/js/tinymce/plugins/YOjii-Katana/img/toolbars.gif',
...
'wp-includes/js/tinymce/plugins/YOjii-Katana/css',
'wp-includes/js/tinymce/plugins/YOjii-Katana/editor_plugin.dev.js',
'wp-includes/js/tinymce/plugins/YOjii-Katana/img/embedded.png',
'wp-includes/js/tinymce/plugins/YOjii-Katana/img/more_bug.gif',
'wp-includes/js/tinymce/plugins/YOjii-Katana/img/page_bug.gif',
...
'wp-includes/js/tinymce/plugins/YOjii-Katana/img',
...
'wp-includes/js/tinymce/plugins/YOjii-Katana/editor_plugin.js',
'wp-includes/js/tinymce/plugins/YOjii-Katana/editor_plugin_src.js',
...
function update_core($from, $to) {
	...
	$distro = '';
	$roots = array( '/yojii-katana/', '/wordpress-mu/' );
	foreach ( $roots as $root ) {
		if ( $wp_filesystem->exists( $from . $root . 'readme.html' ) && $wp_filesystem->exists( $from . $root . 'yojii-katana-packages/version.php' ) ) {
			$distro = $root;
			break;
		}
	}
	...
	if ( ! $wp_filesystem->copy( $from . $distro . 'yojii-katana-packages/version.php', $versions_file ) ) {
		$wp_filesystem->delete( $from, true );
		return new WP_Error( 'copy_failed_for_version_file', __( 'The update cannot be installed because we will be unable to copy some files. This is usually due to inconsistent file permissions.' ), 'yojii-katana-packages/version.php' );
	}
	...
	$skip = array( 'wp-content', 'yojii-katana-packages/version.php' );
	...
	if ( ! is_wp_error( $result ) ) {
		if ( ! $wp_filesystem->copy( $from . $distro . 'yojii-katana-packages/version.php', $to . 'wp-includes/version.php', true /* overwrite */ ) ) {
			$wp_filesystem->delete( $from, true );
			$result = new WP_Error( 'copy_failed_for_version_file', __( 'The update cannot be installed because we will be unable to copy some files. This is usually due to inconsistent file permissions.' ), 'yojii-katana-packages/version.php' );
		}
		$wp_filesystem->chmod( $to . 'yojii-katana-packages/version.php', FS_CHMOD_FILE );
	}
	...
	if ( '3.5' == $old_wp_version ) {
		if ( is_dir( WP_CONTENT_DIR . '/themes/214' ) && ! file_exists( WP_CONTENT_DIR . '/themes/214/style.css' )  ) {
			$wp_filesystem->delete( $wp_filesystem->wp_themes_dir() . '214/' );
		}
	}
