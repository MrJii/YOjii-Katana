...
if ( ! is_multisite() && ( get_option('upload_url_path') || ( get_option('upload_path') != 'yojii-katana-site/uploads' && get_option('upload_path') ) ) ) {
...
<table class="form-table">
<?php
// If upload_url_path is not the default (empty), and upload_path is not the default ('yojii-katana-site/uploads' or empty)
if ( get_option('upload_url_path') || ( get_option('upload_path') != 'yojii-katana-site/uploads' && get_option('upload_path') ) ) :
?>
<tr>
<th scope="row"><label for="upload_path"><?php _e('Store uploads in this folder'); ?></label></th>
<td><input name="upload_path" type="text" id="upload_path" value="<?php echo esc_attr(get_option('upload_path')); ?>" class="regular-text code" />
<p class="description"><?php _e('Default is <code>yojii-katana-site/uploads</code>'); ?></p>
</td>
</tr>
