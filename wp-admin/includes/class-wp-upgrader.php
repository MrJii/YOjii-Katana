...
/**
 * YOjii-Katana Upgrader class for Upgrading/Installing a local set of files via the Filesystem Abstraction classes from a Zip file.
 *
...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_content_dir'] = __('Unable to locate WordPress Content directory (yojii-katana-site).');
...
class Core_Upgrader extends WP_Upgrader {
	...
	public function upgrade( $current, $args = array() ) {
		...
		if ( !$wp_filesystem->copy($working_dir . '/YOjii-Katana/wp-admin/includes/update-core.php', $wp_dir . 'wp-admin/includes/update-core.php', true) ) {
			$wp_filesystem->delete($working_dir, true);
	...
	public function check_files() {
		...
		foreach ( $checksums as $file => $checksum ) {
			...
			if ( 'yojii-katana-site' == substr( $file, 0, 10 ) )
				continue;
