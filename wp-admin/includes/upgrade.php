...
function wp_install_defaults( $user_id ) {
	...
	if ( is_multisite() ) {
		...
		$first_post = __('Welcome to YOjii-Katana. This is your first post. Edit or delete it, then start blogging!');
	}
...
https://facebook.com/MrJii/YOjii-Katana
...
/**
 * Run YOjii-Katana Upgrade functions.
 *
 * {@internal Missing Long Description}}
 *
 * @since 2.1.0
...
/**
 * Execute changes made in YOjii-Katana 1.0.
 *
 * @since 1.0.0
 */
