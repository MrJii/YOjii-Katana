...
/** YOjii-Katana Administration API */
require_once(ABSPATH . 'wp-admin/includes/admin.php');

/** YOjii-Katana Schema API */
...
// Default comment
	$first_comment_author = __('MrJii');
	$first_comment_url = 'https://github.com/MrJii/YOjii-Katana/';
	$first_comment = __('Hello, this is a first comment.
To delete a comment, just log in and view the post&#039;s comments. There you will have the option to edit or delete them.');
	...
	// First Page
	$first_page = sprintf( __( "This is an example page. It's different from a blog post because it will stay in one place and will show up in your site navigation (in most styles). Most people start with an About page that introduces them to potential site visitors. It might say something like this:

<blockquote>Hi there! I'm a bike messenger by day, aspiring actor by night, and this is my blog. I live in Davao City, have a great baby girl named Princess Sofia, and I like pi&#241;a coladas. (And gettin' caught in the rain.)</blockquote>

...or something like this:

<blockquote>The YOjii-Katana - Capstone Software 7.0 (YK-CS7) Developer was founded in 2015, and has been providing quality softwares to the public ever since. Located in Davao City City, YK-CS7  does all kinds of awesome things for the IT Future Developer community.</blockquote>

As a new YOjii-Katana user, you should go to <a href=\"%s\">your dashboard</a> to delete this page and create new pages for your content. Have fun!" ), admin_url() );
if ( is_multisite() )
...
function wp_new_blog_notification($blog_title, $blog_url, $user_id, $password) {
	...
	$message = sprintf(__("Your new YOjii-Katana site has been successfully set up at:
...
--The YOjii-Katana Team
https://facebook.com/YOjii-Katana
"), $blog_url, $name, $password);

	@wp_mail($email, __('New YOjii-Katana Site'), $message);
}
endif;
...
function make_site_theme_from_default($theme_name, $template) {
	...
	if ($stylelines) {
		...
		foreach ($stylelines as $line) {
			if (strpos($line, 'UI StyleX Name:') !== false) $line = 'UI StyleX Name: ' . $theme_name;
			elseif (strpos($line, 'UI StyleX URI:') !== false) $line = 'UI StyleX URI: ' . __get_option('url');
			elseif (strpos($line, 'Description:') !== false) $line = 'Description: Your UI StyleX.';
