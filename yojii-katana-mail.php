 ...
 * a yojii-katana post. Mailbox connection information must be
 * configured under Settings > Writing
 *
 * @package yojii-katana
 */

/** Make sure that the yojii-katana bootstrap has run before continuing. */
 ...
 * @since 2.9.0
 */
do_action( 'yojii-katana-mail.php' );
