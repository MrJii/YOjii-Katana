...
require( dirname( __FILE__ ) . '/yojii-katana-blog-header.php' );
...
if ( !is_multisite() ) {
	wp_redirect( site_url('yojii-katana-login.php?action=register') );
	die();
}

if ( !is_main_site() ) {
	wp_redirect( network_site_url( 'yojii-katana-signup.php' ) );
	die();
}
...
function signup_another_blog( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	<form id="setupform" method="post" action="yojii-katana-signup.php">
...
function confirm_another_blog_signup( $domain, $path, $blog_title, $user_name, $user_email = '', $meta = array() ) {
	...
	<p>
		<?php printf( __( '<a href="http://%1$s">http://%2$s</a> is your new site. <a href="%3$s">Log in</a> as &#8220;%4$s&#8221; using your existing password.' ), $domain.$path, $domain.$path, "http://" . $domain.$path . "yojii-katana-login.php", $user_name ) ?>
	</p>
	<?php
	/**
...
function signup_user( $user_name = '', $user_email = '', $errors = '' ) {
	...
	<form id="setupform" method="post" action="yojii-katana-signup.php" novalidate="novalidate">
		<input type="hidden" name="stage" value="validate-user-signup" />
		<?php
		/** This action is documented in yojii-katana-signup.php */
...
function validate_user_signup() {
	...
	/** This filter is documented in yojii-katana-signup.php */
...
if ( is_super_admin() )
	echo '<div class="mu_alert">' . sprintf( __( 'Greetings Site Administrator! You are currently allowing &#8220;%s&#8221; registrations. To change or disable registration go to your <a href="%s">Options page</a>.' ), $i18n_signup[$active_signup], esc_url( network_admin_url( 'yojii-katana-settings.php' ) ) ) . '</div>';
...
if ( $active_signup == 'none' ) {
	...
	$login_url = site_url( 'yojii-katana-login.php?redirect_to=' . urlencode( network_site_url( 'yojii-katana-signup.php' ) ) );
