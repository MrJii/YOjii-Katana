...
function cordillera_widgets_init() {
		register_sidebar(array(
			'name' => __('Default Sidebar', 'slugglera'),
			'id'   => 'default_sidebar',
		...
		register_sidebar(array(
			'name' => __('Displayed Everywhere', 'slugglera'),
		...
		register_sidebar(array(
			'name' => __('Post Left Sidebar', 'slugglera'),
		...
		register_sidebar(array(
			'name' => __('Post Right Sidebar', 'slugglera'),
		...
		register_sidebar(array(
			'name' => __('Page Left Sidebar', 'slugglera'),
		...
		register_sidebar(array(
			'name' => __('Page Right Sidebar', 'slugglera'),
		...
		register_sidebar(array(
			'name' => __('Archive Sidebar', 'slugglera'),
			'id'   => 'archive_sidebar',
			'before_widget' => '<div id="%1$s" class="widget widget-box %2$s">', 
			'after_widget' => '<span class="seperator extralight-border"></span></div>', 
			'before_title' => '<h2 class="widget-title">', 
		...
		register_sidebar(array(
			'name' => __('Page 404 Right Sidebar', 'slugglera'),
  ...
  "home-page-section-5":["12"]}}';
	...
	$widget_id         = isset($home_sections_array['section-widget-id'][$i])?$home_sections_array['section-widget-id'][$i]:'home-page-section-'.$i;
	...
	$columns           = isset($home_sections_array['widget-area-column-item'][$widget_id])? $home_sections_array['widget-area-column-item'][$widget_id]:array("12");
	...
	$column_num       = count($columns);
		 foreach($columns as $widget){
			 if($column_num > 1){
				 $widget_name = sprintf(__('%s Column %d','slugglera'),$areaname,$j);
				 $widget_id   = $widget_id.'-'.$j;
				 }else{
	...
	register_sidebar(array(
			'name' => __('Footer Area One', 'slugglera'),
			'id'   => 'footer_widget_1',
			'before_widget' => '<div id="%1$s" class="widget widget-box %2$s">', 
			'after_widget' => '<span class="seperator extralight-border"></span></div>', 
			'before_title' => '<h2 class="widget-title">', 
	...
	register_sidebar(array(
			'name' => __('Footer Area Two', 'slugglera'),
			'id'   => 'footer_widget_2',
			'before_widget' => '<div id="%1$s" class="widget widget-box %2$s">', 
			'after_widget' => '<span class="seperator extralight-border"></span></div>', 
			'before_title' => '<h2 class="widget-title">', 
	...
	register_sidebar(array(
			'name' => __('Footer Area Three', 'slugglera'),
			'id'   => 'footer_widget_3',
			'before_widget' => '<div id="%1$s" class="widget widget-box %2$s">', 
			'after_widget' => '<span class="seperator extralight-border"></span></div>', 
			'before_title' => '<h2 class="widget-title">', 
	...
	register_widget('cordillera_service'); // 2 styles for pro version
 ...
 */
 class cordillera_button extends WP_Widget {
 	function cordillera_button() {
 		$widget_ops = array( 'classname' => 'widget_button', 'description' => __( 'Button widget.', 'slugglera' ) );
		$control_ops = array( 'width' => 350, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'Cordillera: Button', 'slugglera' ), $widget_ops, $control_ops);
 	}
	...
	?>
		   ...
		   <p>
         <label for="<?php echo $this->get_field_id( 'btn_style'  ); ?>"><?php _e('Button Style', 'slugglera'); ?>:</label>
             <select id="<?php echo $this->get_field_id( 'btn_style' ); ?>" name="<?php echo $this->get_field_name( 'btn_style' ); ?>">
          
           <option   value="1" <?php echo selected("1",esc_attr( $instance[ 'btn_style'] )) ;?>><?php _e('Style 1', 'slugglera'); ?></option>
          <option   value="2" <?php echo selected("2",esc_attr( $instance[ 'btn_style'] )) ;?>><?php _e('Style 2', 'slugglera'); ?></option>
            </select>
            </p>
            
            <p>
               <label for="<?php echo $this->get_field_id( 'btn_icon'  ); ?>"><?php _e('Button Icon', 'slugglera'); ?>:</label>
			<input id="<?php echo $this->get_field_id( 'btn_icon'  ); ?>" name="<?php echo $this->get_field_name( 'btn_icon'  ); ?>" value="<?php echo esc_attr($instance['btn_icon']); ?>" class="" placeholder="<?php _e('Font Awesome Icon', 'slugglera'); ?>"/>
            </p>
              <p>
               <label for="<?php echo $this->get_field_id( 'btn_text'  ); ?>"><?php _e('Button Text', 'slugglera'); ?>:</label>
			<input id="<?php echo $this->get_field_id( 'btn_text'  ); ?>" name="<?php echo $this->get_field_name( 'btn_text'  ); ?>" value="<?php echo esc_attr($instance['btn_text']); ?>" class="" placeholder=""/>
             ...
             <p>
               <label for="<?php echo $this->get_field_id( 'btn_link'  ); ?>"><?php _e('Button Link', 'slugglera'); ?>:</label>
            ...
            <p>
         <label for="<?php echo $this->get_field_id( 'new_window'  ); ?>"><?php _e('Open in New Window', 'slugglera'); ?>:</label>
             <select id="<?php echo $this->get_field_id( 'new_window' ); ?>" name="<?php echo $this->get_field_name( 'new_window' ); ?>">
          
           <option   value="yes" <?php echo selected("yes",esc_attr( $instance[ 'new_window'] )) ;?>><?php _e('yes', 'slugglera'); ?></option>
          <option   value="no" <?php echo selected("no",esc_attr( $instance[ 'new_window'] )) ;?>><?php _e('no', 'slugglera'); ?></option>
            </select>
            </p>
...
class cordillera_service extends WP_Widget {
 	function cordillera_service() {
 		$widget_ops = array( 'classname' => 'widget_service', 'description' => __( 'Display service. Best for homepage section one ', 'slugglera' ) );
		$control_ops = array( 'width' => 350, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'Slugglera: Service', 'slugglera' ), $widget_ops, $control_ops);
 	}
	...
	?>
		...
		<p>
         <label for="<?php echo $this->get_field_id( 'service_icon_type'  ); ?>"><?php _e('Icon Type', 'slugglera'); ?>:</label>
             <select id="<?php echo $this->get_field_id( 'service_icon_type' ); ?>" name="<?php echo $this->get_field_name( 'service_icon_type' ); ?>">
          
           <option   value="font" <?php echo selected("font",esc_attr( $instance[ 'service_icon_type'] )) ;?>><?php _e('font', 'slugglera'); ?></option>
          <option   value="image" <?php echo selected("image",esc_attr( $instance[ 'service_icon_type'] )) ;?>><?php _e('image', 'slugglera'); ?></option>
            </select>
            </p>
             <p>
               <label for="<?php echo $this->get_field_id( 'service_font_icon' ); ?>"><?php _e('Font Awesome Icon', 'slugglera'); ?>:</label>
			<input id="<?php echo $this->get_field_id( 'service_font_icon'   ); ?>" name="<?php echo $this->get_field_name(  'service_font_icon'   ); ?>" value="<?php echo esc_attr( $instance[ 'service_font_icon' ] ); ?>" class="" /> 
             ...
             <p>
               <label for="<?php echo $this->get_field_id( 'service_image_icon' ); ?>"><?php _e('Image Icon Url', 'slugglera'); ?>:</label>
			<input id="<?php echo $this->get_field_id( 'service_image_icon'   ); ?>" name="<?php echo $this->get_field_name(  'service_image_icon'   ); ?>" value="<?php echo esc_url( $instance[ 'service_image_icon' ] ); ?>" class="" /> 
              ...
              <p>
               <label for="<?php echo $this->get_field_id( 'service_title' ); ?>"><?php _e('Title', 'slugglera'); ?>:</label>
            ...
            <p>
               <label for="<?php echo $this->get_field_id( 'service_link' ); ?>"><?php _e('Title Link', 'slugglera'); ?>:</label>
            ...
            <p>
            <label for="<?php echo $this->get_field_id( 'service_text'  ); ?>"><?php _e('Content', 'slugglera'); ?>:</label>
 ...
 */
 class cordillera_divider extends WP_Widget {
 	function cordillera_divider() {
 		$widget_ops = array( 'classname' => 'widget_divider', 'description' => __( 'Divider for each row.', 'slugglera' ) );
		$control_ops = array( 'width' => 350, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'Cordillera: Divider', 'slugglera' ), $widget_ops, $control_ops);
 	}
	...
	$instance = wp_parse_args( (array) $instance, $defaults ); ?>
            ...
            <p>
               <label for="<?php echo $this->get_field_id( 'height'  ); ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php _e('Height', 'slugglera'); ?>:</label>
			<input id="<?php echo $this->get_field_id( 'height'  ); ?>" name="<?php echo $this->get_field_name( 'height'  ); ?>" value="<?php echo absint($instance['height']); ?>" class="" placeholder="<?php _e('Divider height', 'slugglera'); ?>"/> px
            </p>
 ...
 */
 class cordillera_title extends WP_Widget {
 	function cordillera_title() {
 		$widget_ops = array( 'classname' => 'widget_title', 'description' => __( 'Display section title.', 'slugglera' ) );
		$control_ops = array( 'width' => 350, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'cordillera: Section Title', 'slugglera' ), $widget_ops, $control_ops);
 	}
	...
	$instance = wp_parse_args( (array) $instance, $defaults ); ?>
             ...
             <p>
               <label for="<?php echo $this->get_field_id( 'title'  ); ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php _e('Title', 'slugglera'); ?>:</label>
			<input id="<?php echo $this->get_field_id( 'title'  ); ?>" name="<?php echo $this->get_field_name( 'title'  ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>" class="" /> 
             ...
             <p>
               <label for="<?php echo $this->get_field_id( 'sub_title'  ); ?>"><?php _e('Sub-Title', 'slugglera'); ?>:</label>
...
class cordillera_portfolio extends WP_Widget {
 	function cordillera_portfolio() {
 		$widget_ops = array( 'classname' => 'widget_portfolio', 'description' => __( 'Display pages as portfolio.', 'slugglera' ) );
		$control_ops = array( 'width' => 350, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'cordillera: Portfolio', 'slugglera' ), $widget_ops, $control_ops);
 	}
	...
	?>
     ...
     <p><label for="<?php echo $this->get_field_id( 'columns' ); ?>"><?php _e( 'columns', 'slugglera' ); ?>:</label>
	...
	?>
		 ...
		 <p><label for="<?php echo $this->get_field_id( 'portfolio_'.$i ); ?>"><?php printf(__( 'Page  %s', 'slugglera' ),($i+1)); ?>:</label>
...
<?php
 ...
 $thumbnail = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), "cordillera_portfolio_thumb" );
...
class cordillera_testimonial extends WP_Widget {
 	function cordillera_testimonial() {
 		$widget_ops = array( 'classname' => 'cordillera_testimonial', 'description' => __( 'slugglera testimonial.', 'slugglera' ) );
		$control_ops = array( 'width' => 350, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'cordillera: Testimonial', 'slugglera' ), $widget_ops, $control_ops);
 	}
	...
	?>
     ...
     <p>
            <label for="<?php echo $this->get_field_id( 'name'.$i  ); ?>"><?php printf(__('Name %s', 'slugglera'),$i); ?>:</label>
     ...
     <p>
            <label for="<?php echo $this->get_field_id( 'byline'.$i); ?>"><?php printf(__('Byline %s', 'slugglera'),$i); ?>:</label>
		  ...
		  <p>
            <label for="<?php echo $this->get_field_id( 'content'.$i); ?>"><?php printf(__('Content %s', 'slugglera'),$i); ?>:</label>
		...
		echo '<div class="testimonial-wrapper">
				...
				echo '</div>
							...
							<a class="left carousel-control" href="#'.$testimonial_id.'" role="button" data-slide="prev">
								...
								<span class="sr-only">'.__('Previous', 'slugglera').'</span>
							</a>
							<a class="right carousel-control" href="#'.$testimonial_id.'" role="button" data-slide="next">
								<span class="fa fa-caret-right"></span>
								<span class="sr-only">'.__('Next', 'slugglera').'</span>
							</a>
						</div>
					</div>';
 ...
 */
 ...
 class cordillera_carousel extends WP_Widget {
 	function cordillera_carousel() {
		...
		parent::WP_Widget( false, $name = __( 'cordillera: Carousel', 'slugglera' ), $widget_ops, $control_ops);
 	}
	...
	?>
          ...
          <p>
         <label for="<?php echo $this->get_field_id( 'list_num' ); ?>">&nbsp;&nbsp;<?php _e('Display Num', 'slugglera'); ?>:</label>
		...
		?>
         <p>
            <label for="<?php echo $this->get_field_id( 'title_'.$i  ); ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php _e('Title', 'slugglera'); echo " ".($i+1) ;?>:</label>
			<input id="<?php echo $this->get_field_id( 'title_'.$i ); ?>" name="<?php echo $this->get_field_name( 'title_'.$i ); ?>" value="<?php echo esc_attr($title) ; ?>" class="" /> 
			 ...
			 <p>
            <label for="<?php echo $this->get_field_id( 'image_'.$i  ); ?>"><?php _e('Image URL', 'slugglera'); echo " ".($i+1);?>:</label>
...
class cordillera_blog extends WP_Widget {
 	function cordillera_blog() {
 		$widget_ops = array( 'classname' => 'cordillera_blog', 'description' => __( 'Display latest blog.', 'slugglera' ) );
		$control_ops = array( 'width' => 350, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'cordillera: Blog', 'slugglera' ), $widget_ops, $control_ops);
 	}
	...
	?>
             <p>
               <label for="<?php echo $this->get_field_id( 'blog_num'  ); ?>"><?php _e('Posts List Num', 'slugglera'); ?>:</label>
	...
	function widget( $args, $instance ) {
	    ...
	    while( $get_posts->have_posts() ):$get_posts->the_post();
		  ...
		  if ( has_post_thumbnail() ) { 
		  $featured_image_url = wp_get_attachment_image_src( get_post_thumbnail_id(), 'cordillera_widget_blog' );
									...
									<div class="entry-header">
										...
										<div class="entry-meta">
											...
											echo '<div class="entry-comments">';
											 comments_popup_link( __('No comments yet', 'slugglera'), __('1 comment', 'slugglera'), __('% comments', 'slugglera'), 'comments-link', __('No comment', 'slugglera'));
											echo '</div>
										</div>
									</div>
									<div class="entry-summary">'.get_the_excerpt().'</div>
									<a href="'.get_permalink().'"><button class="btn-normal line">'. __('Read More', 'slugglera').'</button></a>
								</div>
							</div>		
						</div>
						</div>';
 ...
 */
 ...
 class cordillera_social_icons extends WP_Widget {
 	function cordillera_social_icons() {
		...
		$control_ops = array( 'width' => 300, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'cordillera: Social Icons', 'slugglera' ), $widget_ops, $control_ops);
 	}
 ...
 <p>
		...
		?>
         <p>
            <label for="<?php echo $this->get_field_id( 'title_'.$i  ); ?>"><?php _e('Icon Title', 'slugglera'); echo " ".($i+1) ;?>:</label>
            ...
            <p>
            <label for="<?php echo $this->get_field_id( 'icon_'.$i  ); ?>">&nbsp;&nbsp;<?php _e('Icon', 'slugglera'); echo " ".($i+1) ;?>:</label>
			<input id="<?php echo $this->get_field_id( 'icon_'.$i ); ?>" name="<?php echo $this->get_field_name( 'icon_'.$i ); ?>" value="<?php echo esc_attr($icon) ; ?>" class="" /> 
            </p>
            
			 <p>
            <label for="<?php echo $this->get_field_id( 'link_'.$i  ); ?>">&nbsp;&nbsp;<?php _e('Link', 'slugglera'); echo " ".($i+1);?>:</label>
...
class cordillera_sidebar_slider extends WP_Widget {
 	function cordillera_sidebar_slider() {
 		$widget_ops = array( 'classname' => 'cordillera_sidebar_slider', 'description' => __( 'Display some pages as slider.', 'slugglera' ) );
		$control_ops = array( 'width' => 250, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'Cordillera: Sidebar Slider', 'slugglera' ), $widget_ops, $control_ops);
 	}
	...
	?>
		<?php for( $i=0; $i<6; $i++) { ?>
			<p>
				<label for="<?php echo $this->get_field_id( key($defaults) ); ?>"><?php _e( 'Page', 'slugglera' ); ?>:</label>
