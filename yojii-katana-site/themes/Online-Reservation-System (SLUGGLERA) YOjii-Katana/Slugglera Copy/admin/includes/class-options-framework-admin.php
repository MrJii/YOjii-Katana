...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Theme Options', 'slugglera' ),
			'menu_title' => __( 'Theme Options', 'slugglera' ),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'slugglera' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'slugglera' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'slugglera' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'slugglera' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'slugglera' ), 'updated fade' );
	}
