...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'slugglera' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'slugglera' ),
		'repeat-y'  => __( 'Repeat Vertically', 'slugglera' ),
		'repeat'    => __( 'Repeat All', 'slugglera' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'slugglera' ),
		'top center'    => __( 'Top Center', 'slugglera' ),
		'top right'     => __( 'Top Right', 'slugglera' ),
		'center left'   => __( 'Middle Left', 'slugglera' ),
		'center center' => __( 'Middle Center', 'slugglera' ),
		'center right'  => __( 'Middle Right', 'slugglera' ),
		'bottom left'   => __( 'Bottom Left', 'slugglera' ),
		'bottom center' => __( 'Bottom Center', 'slugglera' ),
		'bottom right'  => __( 'Bottom Right', 'slugglera' )
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'slugglera' ),
		'fixed'  => __( 'Fixed in Place', 'slugglera' )
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'slugglera' ),
		'italic'      => __( 'Italic', 'slugglera' ),
		'bold'        => __( 'Bold', 'slugglera' ),
		'bold italic' => __( 'Bold Italic', 'slugglera' )
		);
