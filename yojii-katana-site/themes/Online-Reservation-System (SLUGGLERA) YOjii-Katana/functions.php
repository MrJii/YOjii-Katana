...
define( 'CORDILLERA_JIHADC_FRAMEWORK', get_template_directory().'/admin/' ); 
define( 'CORDILLERA_JIHADC_FRAMEWORK_URI',  CORDILLERA_THEME_BASE_URL. '/admin/'); 
define('CORDILLERA_JIHADC_PREFIXED' ,'slugglera_');

define( 'JIHADC_FRAMEWORK_DIRECTORY', get_template_directory_uri() . '/admin/' );
...
/**
 * Required: include JIHADC framework.
 */
