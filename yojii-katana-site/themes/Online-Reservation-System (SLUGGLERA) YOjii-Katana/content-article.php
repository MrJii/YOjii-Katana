								...
								<div class="entry-main">
									<div class="entry-header">
                                        ...
                                        <div class="entry-meta">
                                            ...
                                            <div class="entry-comments"><?php  comments_popup_link( __('No comments yet','slugglera'), __('1 comment','slugglera'), __('% comments','slugglera'), 'comments-link', __('No comment','slugglera'));?></div>
                                           <?php edit_post_link( __('Edit','slugglera'), '<div class="entry-edit">', '</div>', get_the_ID() ); ?> 
                                        </div>
                                    </div>
