...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'cordillera' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'cordillera' ),
		'repeat-y'  => __( 'Repeat Vertically', 'cordillera' ),
		'repeat'    => __( 'Repeat All', 'cordillera' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'cordillera' ),
		'top center'    => __( 'Top Center', 'cordillera' ),
		'top right'     => __( 'Top Right', 'cordillera' ),
		'center left'   => __( 'Middle Left', 'cordillera' ),
		'center center' => __( 'Middle Center', 'cordillera' ),
		'center right'  => __( 'Middle Right', 'cordillera' ),
		'bottom left'   => __( 'Bottom Left', 'cordillera' ),
		'bottom center' => __( 'Bottom Center', 'cordillera' ),
		'bottom right'  => __( 'Bottom Right', 'cordillera' )
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'cordillera' ),
		'fixed'  => __( 'Fixed in Place', 'cordillera' )
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'cordillera' ),
		'italic'      => __( 'Italic', 'cordillera' ),
		'bold'        => __( 'Bold', 'cordillera' ),
		'bold italic' => __( 'Bold Italic', 'cordillera' )
		);
