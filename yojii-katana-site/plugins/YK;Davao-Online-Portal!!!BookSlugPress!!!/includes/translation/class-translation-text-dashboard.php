        ...
        class DOPBSPTranslationTextDashboard{
            ...
            function dashboard($text){
                ...
                array_push($text, array('key' => 'DASHBOARD_SUBTITLE',
                                        'parent' => 'PARENT_DASHBOARD',
                                        'text' => 'Welcome to DOP Module System'));
                array_push($text, array('key' => 'DASHBOARD_TEXT',
                                        'parent' => 'PARENT_DASHBOARD',
                                        'text' => 'This module will help you to easily create a online booking/reservation modular system on your WP Framework (WordPress) CMS or Content Management System. This is intended to book, anything, anywhere, anytime ... so if you have any suggestions please tell us.'));
                /*
                 * Get started
                 */
                ...
                array_push($text, array('key' => 'DASHBOARD_SERVER_MEMORY_LIMIT_WP',
                                        'parent' => 'PARENT_DASHBOARD',
                                        'text' => 'WP Framework memory limit'));
                array_push($text, array('key' => 'DASHBOARD_SERVER_MEMORY_LIMIT_WP_MAX',
                                        'parent' => 'PARENT_DASHBOARD',
                                        'text' => 'WP Framework maximum memory limit'));
                ...
                array_push($text, array('key' => 'DASHBOARD_SERVER_CURL_VERSION',
                                        'parent' => 'PARENT_DASHBOARD',
                                        'text' => '(WARNING!) cURL version - necessary for TLS security protocol'));
