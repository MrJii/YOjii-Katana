    ...
    if (!class_exists('DOPBSPFrontEndSearchResults')){
        class DOPBSPFrontEndSearchResults extends DOPBSPFrontEndSearch{
            ...
            function get(){
                 ...
                 * Tables
                 */
                array_push($query, 'SELECT calendars.id, calendars.post_id, calendars.name, calendars.price_min, calendars.address, calendars.address_alt, calendars.coordinates, settings_calendar.hours_interval_enabled, settings_search.currency, settings_search.currency_position');
