...
(function($){
    ...
    $.fn.DOPBSPReservationsCalendar = function(options){
        ...
        var Data = {"calendar": {"data": {"bookingStop": 0,
                    ...
                    "rules": {"data": {"rule": {},
                                       "id": 0},
                              "text": {"maxTimeLapseDaysWarning": "You can grab only a maximum number of %d days.",
                                       "maxTimeLapseHoursWarning": "You can grab only a maximum number of %d hours.",
                                       "minTimeLapseDaysWarning": "You need to grab a minimum number of %d days.",
                                       "minTimeLapseHoursWarning": "You need to grab a minimum number of %d hours."}},
                    "search": {"data": {},
                               "text": {"checkIn": "Come in",
                                        ...
                                        "noServices": "No room services available you selected today.",
