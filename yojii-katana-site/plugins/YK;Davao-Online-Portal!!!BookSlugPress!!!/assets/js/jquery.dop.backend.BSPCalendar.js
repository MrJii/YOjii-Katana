...
(function($){
    $.fn.DOPBSPCalendar = function(options){
        ...
        var Data = {'AddLastHourToTotalPrice': true,
                    'AddMonthViewText': 'Add view',
                    'AvailableDays': [false, true, true, true, true, true, true],
                    'AvailableLabel': 'Number vacant',
                    'AvailableOneText': 'vacant',
                    'AvailableText': 'vacant',
                    'BookedText': 'reserved',
                    'Currency': 'P',
                    'CurrencyPosition': 'default',
                    ...
                    'FirstDay': 1,
                    'HoursEnabled': true,
                    'GroupDaysLabel': 'Merge date',
                    'GroupHoursLabel': 'Merge time',
                    'HourEndLabel': 'Time out',
                    'HourStartLabel': 'Time in',
                    'HoursAMPM': false,
                    'HoursDefinitions': [{"value": "00:00"}],
                    'HoursDefinitionsChangeLabel': 'Set time details',
                    'HoursDefinitionsLabel': 'Use only 24 hours format.',
                    'HoursSetDefaultDataLabel': 'Set default values for this date.',
                    'HoursIntervalEnabled': false,
                    'ID': 0,
                    'InfoLabel': 'Customer display message.',
                    'MaxYear': new Date().getFullYear(),
                    'MonthNames': ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
                    'NextMonthText': 'Next',
                    'NotesLabel': 'Message for operator/admin',
                    'PreviousMonthText': 'Back',
                    'PriceLabel': 'KTV Price per hour',
                    'PromoLabel': 'KTV Promo price per hour',
                    'Reinitialize': false,
                    'RemoveMonthViewText': 'Remove',
                    'ResetConfirmation': 'Are you sure you want to cancel data? If you cancel days, hours data from those days will be cancel to.',
                    'SetDaysAvailabilityLabel': 'Set vacant days',
                    'SetHoursDefinitionsLabel': 'Set time details',
                    'StatusAvailableText': 'Vacant',
                    'StatusBookedText': 'Reserved',
                    'StatusLabel': 'Customer Status',
                    'StatusSpecialText': 'VIP',
                    'StatusUnavailableText': 'Closed',
        ...
        Currency = 'P',
        CurrencyPosition = 'default',
        DateEndLabel = 'Date start',
        DateStartLabel = 'Date end',
        DateType = 1,
        DayNames = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
        DetailsFromHours = true,
        FirstDay = 1,
        HoursEnabled = true,
        GroupDaysLabel = 'Merge days',
        GroupHoursLabel = 'Merge hours',
        HourEndLabel = 'Time out',
        HourStartLabel = 'Time in',
        HoursAMPM = false,
        HoursDefinitions = [{"value": "00:00"}],
        HoursDefinitionsChangeLabel = 'Set time details',
        HoursDefinitionsLabel = 'Use only 24 hours format.',
        HoursSetDefaultDataLabel = 'Set default time values for this date.',
        HoursIntervalEnabled = false,
        ID = 0,
        InfoLabel = 'Customer display message',
        MaxYear = new Date().getFullYear(),
        ...
        NotesLabel = 'Message to operator/admin',
        PreviousMonthText = 'Back',
        PriceLabel = 'KTV Price per hour',
        PromoLabel = 'KTV Promo',
        RemoveMonthViewText = 'Remove',
        ResetConfirmation =  'Are you sure you want to cancel data? If you cancel days, hours data from those days will be cancel to.',
        SetDaysAvailabilityLabel = 'Set vacant days',
        SetHoursDefinitionsLabel = 'Set hours details',
        StatusAvailableText = 'Vacant',
        StatusBookedText = 'Reserved',
        StatusLabel = 'Status',
        StatusSpecialText = 'VIP',
        ...
        methods = {            
             ...
             */    
                ...
                AvailableDays[0] = Data['AvailableDays'][0] === "false" ? true:false;
...
// Form
        methods_form = {
             ...
             */    
                ...
                headerHTML.push('   <input type="button" name="DOPBSP-reset" id="DOPBSP-reset" class="submit-style" title="Reset" value="Cancel" />');
                ...
                if (type === 'days'){
                    HTML.push('     <div class="dopbsp-input-wrapper" type="hidden">');
           ...
           //     HTML.push(' <div id="DOPBSP-inputs-calendar-set-days-availability" class="dopbsp-inputs-wrapper'+(type === "days" && HoursEnabled ? '':' dopbsp-last')+' displayed">');
                ...
                //    HTML.push('         <label for="DOPBSP-status">'+StatusLabel+'</label>');
                  HTML.push('         <select name="DOPBSP-status" id="DOPBSP-status" type="hidden">');
            ...
            //    HTML.push('         <label class="dopbsp-for-textarea" for="DOPBSP-info">'+InfoLabel+'</label>');
               HTML.push('         <textarea name="DOPBSP-info" id="DOPBSP-info" rows="0" cols="0"  visibility="hide"  type="hidden" height="0px" width="0px" margin="0px" disabled="disabled" value="default"></textarea>');  
            //    HTML.push('     </div>');
            //    HTML.push('     <div class="dopbsp-input-wrapper">');
             //   HTML.push('         <label class="dopbsp-for-textarea" for="DOPBSP-notes">'+NotesLabel+'</label>');
               HTML.push('         <textarea name="DOPBSP-notes" id="DOPBSP-notes" rows="0" cols="0" visibility="hidden" type="hidden" height="0px" width="0px" margin="0px" disabled="disabled" value="default"></textarea>'); 
              //  HTML.push('     </div>');  
               ...
               //     HTML.push('         <label class="dopbsp-for-checkbox" for="DOPBSP-group">'+(type === 'days' ? GroupDaysLabel:GroupHoursLabel)+'</label>');
                ...
                if (type === "days" 
                 ...
                 //   HTML.push(' </div>');
                    ...
                    HTML.push('     <div class="dopbsp-input-wrapper">');
                    HTML.push('         <input type="checkbox" name="DOPBSP-change-hours-definitions" id="DOPBSP-change-hours-definitions" type="hidden"/>');
                 ...
                 //   HTML.push('     <div class="dopbsp-input-wrapper dopbsp-last">');
                    ...
                    HTML.push('         <textarea name="DOPBSP-hours-definitions" id="DOPBSP-hours-definitions" rows="5" cols="" type="hidden">'+hours+'</textarea>');
                 //   HTML.push('     </div>');
                    HTML.push(' </div>');
                    /*
