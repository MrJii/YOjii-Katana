                    ...
                    <tr>
                        <td class="dopbsp-column" id="DOPBSP-column1">
                            <div class="dopbsp-column-header">
                                <!--a href="< ?php echo DOPBSP_CONFIG_HELP_DOCUMENTATION_URL; ?>" target="_blank" class="dopbsp-button dopbsp-help"><span class="dopbsp-info dopbsp-help">
								< ?php echo $DOPBSP->text('RESERVATIONS_HELP').'<br /><br />'.$DOPBSP->text('HELP_VIEW_DOCUMENTATION'); ?></span></a-->                           
...
?>                        
                                ...
                                <div id="DOPBSP-inputs-reservations-filters-calendars" class="dopbsp-inputs-wrapper">
                                    ...
                                    <div class="dopbsp-input-wrapper">
                                        ...
                                        <!--a href="< ?php echo DOPBSP_CONFIG_HELP_DOCUMENTATION_URL; ?>" target="_blank" class="dopbsp-button dopbsp-help"><span class="dopbsp-info dopbsp-help">
										< ?php echo $DOPBSP->text('RESERVATIONS_FILTERS_CALENDAR_HELP'); ?><br /><br />< ?php echo $DOPBSP->text('HELP_VIEW_DOCUMENTATION'); ?></span></a-->
                                    </div>
                                ...
                                -->
                                    ...
                                    <div id="DOPBSP-reservations-end-date-wrapper" class="dopbsp-input-wrapper dopbsp-data">
                                        ...
                                        <!--a href="< ?php echo DOPBSP_CONFIG_HELP_DOCUMENTATION_URL; ?>" target="_blank" class="dopbsp-button dopbsp-help"><span class="dopbsp-info dopbsp-help"><?php echo $DOPBSP->text('RESERVATIONS_FILTERS_END_DAY_HELP'); ?><br /><br />
										< ?php echo $DOPBSP->text('HELP_VIEW_DOCUMENTATION'); ?></span></a-->
                                    </div>
<?php
                /*
                 * Start hour.
                                ...
                                <div id="DOPBSP-inputs-reservations-filters-payment" class="dopbsp-inputs-wrapper">
                                    <div class="dopbsp-input-wrapper last">
                                        ...
                                        <div class="dopbsp-checkboxes-wrapper">  
                                            ...
                                            <label class="dopbsp-for-checkbox" for="DOPBSP-reservations-payment-arrival"><?php echo ('Walk-In'); ?></label>  
                                            <br class="dopbsp-clear" />
                                            <!--
                                                WooCommerce
