									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<p class="description"><?php _e( 'Tag to be output' , 'wp-admin-ui-customize' ); ?> : <code><?php echo esc_html( '<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="' . get_bloginfo('wpurl') . '/yojii-katana-packages/wlwmanifest.xml" />' ); ?></code></p>
											</td>
										</tr>
										<?php $field = 'rsd_link'; ?>
										<tr>
