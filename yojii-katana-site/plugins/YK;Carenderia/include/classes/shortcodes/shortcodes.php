	...
	abstract class WPBakeryShortCode extends WPBakeryVisualComposerAbstract {
		...
		protected function loadTemplate( $atts, $content = null ) {
			...
			if ( $this->html_template ) {
				...
				trigger_error( sprintf( __( 'Template file is missing for `%s` shortcode. Make sure you have `%s` file in your theme folder.', 'js_composer' ), $this->shortcode, 'yojii-katana-site/themes/your_theme/vc_templates/' . $this->shortcode . '.php' ) );
			}
